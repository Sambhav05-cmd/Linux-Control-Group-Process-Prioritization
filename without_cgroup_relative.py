...
if pid == 0:
    ...
    STATS_STRUCT = struct.Struct("d d d d Q d")  # ready, blocked, swapped, running, faults,resident page ratio
...
def second_child_fn(child_pid):
    ...
    while True:
        ...
        if stats:
            total_time = stats.total_running_time + stats.total_ready_time+stats.total_blocked_time+stats.total_swapped_time
            data1 = struct.pack("d d d d", stats.total_ready_time/total_time, stats.total_blocked_time/total_time,
                                stats.total_swapped_time/total_time, stats.total_running_time/total_time)
