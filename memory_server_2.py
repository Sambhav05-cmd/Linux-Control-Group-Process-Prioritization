...
SHM_SIZE = 1024
# ready, blocked, swapped, running, faults, swaps,lru_isolates, ratio
MEM_STRUCT = struct.Struct("d d d d Q Q Q d")
    ...
    while True:
        ...
        for shm_key, mem in shm_map.items():
            ...
            try:
                ...
                stats_history[shm_key].append((timestamp, faults, swaps,lru ,ratio))
